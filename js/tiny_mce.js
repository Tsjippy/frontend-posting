...
let selectUserHtml = `<div class="wp-editor-help">
    ${userSelect.html}
...
tinymce.create(
  ...
  "tinymce.plugins.select_user",
  {
    init: function (editor, url) {
      editor.addCommand("mceSelect_user", function () {
...
//Register the plugin
tinymce.PluginManager.add("select_user", tinymce.plugins.select_user);
